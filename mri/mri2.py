...
train_filenames = file_folder[0:2900]
valid_filenames = file_folder[2900:]
...
def unet(in_image=(height, width, 1)):
    ...
    conv1 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv1_1')(c1)
...
def train(epoch=5):
    ...
    model.save('/home/CVL1/Shaobo/mri/h5File/mri_morph.h5')
...
def plot_loss():
    ...
    plt.legend()
    plt.show()
    plt.savefig('/home/CVL1/Shaobo/mri/training_morph.png')
    return
...
def plot_img():
    with CustomObjectScope({'Dilation2D': Dilation2D, 'Erosion2D': Erosion2D}):
        model = load_model('/home/CVL1/Shaobo/mri/h5File/mri_morph.h5')
    gb = get_batch(valid_filenames,50)
    abatch = next(gb)
    ...
    plt.show()
    plt.savefig('/home/CVL1/Shaobo/mri/outputs/plot_valid_morph.png')
...
def plot_saliency():
   ...
   # ax4.get_yaxis().set_visible(False)
    ...
    plt.show()
    plt.savefig('/home/CVL1/Shaobo/mri/outputs/test.jpg')
